...
public class ExcelUtils {
     ...
     * @param colName
     */
    public static void initExcel(String fileName, String[] colName, String xixi) {
        format();
        ...
        try {
            ...
            WritableSheet sheet = workbook.createSheet(xixi, 0);
            //创建标题栏
    ...
    public static <T> void writeObjListToExcel(List<T> objList, String fileName, Context c, LoadingDialog mDialog) {
