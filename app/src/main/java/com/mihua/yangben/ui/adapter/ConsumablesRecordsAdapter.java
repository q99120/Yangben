 ...
 * 耗材记录列表适配器
 */
public class ConsumablesRecordsAdapter extends RecyclerView.Adapter<ConsumablesRecordsAdapter.ViewHolder> {
    ...
    public ConsumablesRecordsAdapter(Context contexts, List<HisRecord> hisRecords) {
        context = contexts;
